      ...
      <div className="max-w-[1200px] mx-auto px-4">
        <div className="flex flex-col sm:flex-row justify-between">
          <div className="mb-6 sm:mb-0">
            <Link to="/" className="text-xl font-bold text-gray-900 dark:text-white">Stairway</Link>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/notices" className="text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                    공지사항
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/inquiries" className="text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                    문의하기
                  </Link>
                </li>
              </ul>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-4 mt-8 text-center">
          <p className="text-xs text-gray-500 dark:text-gray-500">
            © {new Date().getFullYear()} Stairway. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
